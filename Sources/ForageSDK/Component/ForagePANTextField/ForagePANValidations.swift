...
class ForagePANValidations {
    ...
    static var panNumbers: [StateIIN] = [
        ...
        StateIIN(state: USState.district_of_columbia, panNumber: "507707", panLength: 16),
        ...
        StateIIN(state: USState.new_hampshire, panNumber: "507701", panLength: 16),
        StateIIN(state: USState.new_jersey, panNumber: "610434", panLength: 16),
        StateIIN(state: USState.new_mexico, panNumber: "586616", panLength: 16),
        StateIIN(state: USState.new_york, panNumber: "600486", panLength: 19),
        StateIIN(state: USState.north_carolina, panNumber: "508161", panLength: 16),
        StateIIN(state: USState.north_dakota, panNumber: "508132", panLength: 16),
        ...
        StateIIN(state: USState.rhode_island, panNumber: "507682", panLength: 16),
        StateIIN(state: USState.south_carolina, panNumber: "610470", panLength: 16),
        StateIIN(state: USState.south_dakota, panNumber: "508132", panLength: 16),
        StateIIN(state: USState.tennessee, panNumber: "507702", panLength: 16),
        StateIIN(state: USState.texas, panNumber: "610098", panLength: 19),
        StateIIN(state: USState.us_virgin_islands, panNumber: "507721", panLength: 16),
        ...
        StateIIN(state: USState.west_virginia, panNumber: "507720", panLength: 16),
