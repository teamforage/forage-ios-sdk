...
public class ForageCardNumber: UIView, Identifiable, ForageElement, ForageElementDelegate {
    ...
    lazy var enhancedTextField: CardNumber = {
        let tf = CardNumber()
        ...
        tf.accessibilityIdentifier = "tf_forage_card_number_text_field"
...
extension ForageCardNumber {
    /// Make `ForageCardNumber` focused.
...
extension ForageCardNumber: UITextFieldDelegate {
