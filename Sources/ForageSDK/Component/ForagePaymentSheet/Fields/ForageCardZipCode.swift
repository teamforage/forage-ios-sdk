...
public class ForageCardZipCode: UIView, Identifiable, ForagePaymentSheetField, ForageElementDelegate {
    // MARK: - Properties
    public var name: String = "cardZipCodeTextField"
    ...
    lazy var enhancedTextField: CardZipCode = {
        let tf = CardZipCode()
...
extension ForageCardZipCode {
    /// Make `ForageCardZipCode` focused.
    @discardableResult override public func becomeFirstResponder() -> Bool {
        enhancedTextField.becomeFirstResponder()
    }

    /// Remove  focus from `ForageCardZipCode`.
    @discardableResult override public func resignFirstResponder() -> Bool {
        isTouched = true
        return enhancedTextField.resignFirstResponder()
    }

    /// Check if `ForageCardZipCode` is focused.
    override public var isFirstResponder: Bool {
        enhancedTextField.isFirstResponder
    }
}

extension ForageCardZipCode: UITextFieldDelegate {
