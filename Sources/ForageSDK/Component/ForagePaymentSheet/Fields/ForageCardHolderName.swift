...
public class ForageCardHolderName: UIView, Identifiable, ForagePaymentSheetField, ForageElementDelegate {
    // MARK: - Properties
    public var name: String = "ForageCardHolderName"
    ...
    @IBInspectable public var isValid: Bool {
        return enhancedTextField.isValid
    }
    ...
    /// UITextField with floating placeholder label functionality.
    lazy var enhancedTextField: CardHolderName = {
        let tf = CardHolderName()
        ...
        tf.accessibilityIdentifier = "tf_forage_cardholder_name_text_field"
...
extension ForageCardHolderName {
    /// Make `ForageCardHolderName` focused.
    @discardableResult override public func becomeFirstResponder() -> Bool {
        enhancedTextField.becomeFirstResponder()
    }

    /// Remove  focus from `ForageCardHolderName`.
    @discardableResult override public func resignFirstResponder() -> Bool {
        isTouched = true
        return enhancedTextField.resignFirstResponder()
    }

    /// Check if `ForageCardHolderName` is focused.
    override public var isFirstResponder: Bool {
        enhancedTextField.isFirstResponder
    }
}

extension ForageCardHolderName: UITextFieldDelegate {
